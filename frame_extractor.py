...
class FrameExtractor:
    def __init__(self, video_path, output_dir,fname):
    ...
    def extract_frames_by_percentage(self, percentage=100):
        ...
        while self.frame_count < frames_to_extract:
            ...
            if not ret:
                break
            frame_filename = os.path.join(self.output_dir, f"{self.fname}_{self.frame_count:04d}.jpg")
